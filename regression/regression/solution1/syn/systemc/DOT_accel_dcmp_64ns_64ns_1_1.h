...
#ifndef __DOT_accel_dcmp_64ns_64ns_1_1__HH__
#define __DOT_accel_dcmp_64ns_64ns_1_1__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(DOT_accel_dcmp_64ns_64ns_1_1) {
    ...
    SC_CTOR(DOT_accel_dcmp_64ns_64ns_1_1):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
